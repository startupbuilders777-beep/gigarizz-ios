...
struct ProfileView: View {
    ...
    @State private var showBackgroundReplacer = false
        ...
        GRCard {
            HStack(spacing: DesignSystem.Spacing.m) {
                ZStack {
                    ...
                    Text(String((authManager.userEmail ?? "U").prefix(1)).uppercased())
            ...
            VStack(spacing: DesignSystem.Spacing.s) {
                HStack {
                    ...
                    VStack(alignment: .trailing, spacing: DesignSystem.Spacing.micro) {
                        Text("\(subscriptionManager.availableStyles.count)")
                            .font(DesignSystem.Typography.headline)
    ...
    private var photoAuditSection: some View {
        VStack(alignment: .leading, spacing: DesignSystem.Spacing.s) {
            Label("Photo Audit", systemImage: "chart.bar.fill")
                .font(DesignSystem.Typography.callout)
                .foregroundStyle(DesignSystem.Colors.textPrimary)
            GRButton(
                title: isAnalyzing ? "Analyzing..." : "Score My Photos",
